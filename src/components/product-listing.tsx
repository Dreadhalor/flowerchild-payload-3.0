...
const ProductPlaceholder = () => {
  return (
    <div className='flex min-h-0 w-full flex-col'>
      ...
      <Skeleton className='mt-4 h-4 w-2/3 rounded-lg bg-zinc-100' />
      <Skeleton className='mt-2 h-4 w-16 rounded-lg bg-zinc-100' />
      <Skeleton className='mt-2 h-4 w-12 rounded-lg bg-zinc-100' />
    </div>
  );
};
